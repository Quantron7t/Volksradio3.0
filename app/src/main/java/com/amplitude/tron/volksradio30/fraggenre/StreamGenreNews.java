...
import com.amplitude.tron.volksradio30.datagenre.RadioDataGenreNews;

/**
 * Created by Tron on 1/30/2017.
 */

public class StreamGenreNews extends Fragment {
    ...
    public StreamGenreNews(){}

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.stream_genre_news, container, false);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.streamOneLayout:
                    new RadioDataGenreNews().pushStreamOne(getActivity().getApplicationContext());
                    break;
                case R.id.streamTwoLayout:
                    new RadioDataGenreNews().pushStreamTwo(getActivity().getApplicationContext());
                    break;
            }
        }
    };
