...
import com.amplitude.tron.volksradio30.datagenre.RadioDataGenreSports;

/**
 * Created by Tron on 1/30/2017.
 */

public class StreamGenreSport extends Fragment {
    ...
    public StreamGenreSport(){}

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.stream_genre_sports, container, false);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.streamOneLayout:
                    new RadioDataGenreSports().pushStreamOne(getActivity().getApplicationContext());
                    break;
            }
        }
    };
